...
import 'package:tesla_theater/app_button.dart';
...
class _TeslaTheaterState extends State<TeslaTheater> {
  ...
  void _loadButtons() async {
    ...
    List<AppButtonData> defaultAppButtons = [
      ...
      AppButtonData(
          id: 1,
          icon: Assets.icons.disneyplus.svg(),
          backgroundColor: const Color(0xFF101C50),
          url: 'https://www.disneyplus.com/'),
      AppButtonData(
          id: 2,
          icon: Assets.icons.primevideo.svg(),
          backgroundColor: const Color(0xFF1A98FF),
          url: 'https://www.primevideo.com/'),
      AppButtonData(
          id: 3,
          icon: Assets.icons.appletvplus.svg(),
          backgroundColor: Colors.black,
          url: 'https://tv.apple.com/'),
      AppButtonData(
          id: 4,
          icon: Assets.icons.mycanal.svg(),
          backgroundColor: Colors.black,
      ...
      AppButtonData(
          ...
          backgroundColor: const Color(0xFF002BE7),
          url: 'https://www.max.com/'),
      AppButtonData(
          id: 7,
          icon: Assets.icons.paramoutplus.svg(),
          backgroundColor: const Color(0xFF0164FF),
          url: 'https://www.paramountplus.com/'),
      AppButtonData(
          id: 8,
          icon: Assets.icons.artetv.svg(),
          backgroundColor: Colors.white,
          url: 'https://www.arte.tv/'),
      AppButtonData(
          id: 9,
          icon: Assets.icons.francetv.svg(),
          backgroundColor: const Color(0xFF172128),
          url: 'https://www.france.tv/'),
      AppButtonData(
          id: 10,
          icon: Assets.icons.sfrplay.svg(),
          backgroundColor: Colors.white,
          url: 'https://tv.sfr.fr/'),
      AppButtonData(
          id: 11,
          icon: Assets.icons.orangetv.svg(),
          backgroundColor: const Color(0xFFFF6600),
          url: 'https://chaines-tv.orange.fr/'),
      AppButtonData(
          id: 12,
          icon: Assets.icons.oqee.svg(),
    ...
    if (storedOrder != null) {
      List<AppButtonData> orderedButtons = storedOrder
          .map((id) => defaultAppButtons
              .firstWhere((button) => button.id == int.parse(id)))
          .toList();
  ...
  Future<void> _saveButtonsOrder() async {
    ...
    List<String> appOrder =
        appButtons.map((button) => button.id.toString()).toList();
  ...
  void _launchFullScreen() async {
    ...
    final redirectUri =
        Uri.parse('https://www.youtube.com/redirect?q=$currentUrl');
            ...
            child: Center(
              child: ReorderableWrap(
                ...
                children: appButtons
                    .asMap()
                    .map(
                      (index, buttonData) => MapEntry(
                        index,
                        AppButton(
                          data: buttonData,
                          key: Key('app_button_$index'),
                        ),
                      ),
                    )
                    .values
